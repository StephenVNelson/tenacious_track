...
csv.each do |row|
  ...
  t.position_number = row['position_number']
  t.save
...
# categories = ["Body Position", "Angle", "Support", "Tool", "Resistance Type", "Distraction", "Accessory Movement", "Mode of movement", "R+L", "Resistance"]
# categories.each_with_index do |category, idx|
#   ElementCategory.create!(category_name: category, position_number: idx+1)
# end
